...
def make_paper(
    ...
    return {
        ...
        "first_author": first_author if first_author is not None else (authors[0]["name"] if authors else None),
        "first_author_h_index": first_author_h_index if first_author_h_index is not None else (authors[0].get("h_index") if authors else None),
